...
# Spectral Loss
# To be published
# Origin of Source Code: https://github.com/ChristophRaab/DSN
...
# Coral Loss
# [1]Sun, Baochen ; Saenko, Kate: Deep CORAL: Correlation Alignment for Deep Domain Adaptation.
# In: Hua, G. ; Jégou, H. (Hrsg.): Computer Vision -- ECCV 2016 Workshops. Cham :
# Springer International Publishing, 2016 — ISBN 978-3-319-49409-8, S. 443–450
# Origin of Source Code: https://github.com/DenisDsh/PyTorch-Deep-CORAL
...
# Origin of Source Code: https://github.com/jindongwang/transferlearning/tree/master/code/deep/DDC_DeepCoral
...
def DDC_MMD(source, target, kernel_type='rbf', kernel_mul=2.0, kernel_num=5,fix_sigma = None):
...
# Origin of Source Code: https://github.com/thuml/Xlearn
...
# JAN Loss
# Long, Mingsheng, et al. "Deep transfer learning with joint adaptation networks."
